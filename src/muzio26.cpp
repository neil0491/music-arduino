...
const char s18[] PROGMEM = "Fill Green";
const char s19[] PROGMEM = "Strobe effect";
const char s20[] PROGMEM = "fire";
const char s21[] PROGMEM = "fireblu";
...
static PVu allPatterns[] = {
    ...
    {14, vu_white_red_dots},
    {15, vu_classic_normal},
    {16, vu_classic_centre},
    {18, fillAllGreen},
...
void setup()
{
  ...
  debouncer.attach(buttonPin, INPUT); // Attach the debouncer to a pin with INPUT_PULLUP mode
